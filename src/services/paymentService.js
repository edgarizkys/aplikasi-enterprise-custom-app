...
class PaymentGatewayService {
    constructor() {
        this.serverKey = process.env.PAYMENT_GATEWAY_KEY || 'secret_key_erp_2025';
        this.merchantId = process.env.PAYMENT_MERCHANT_ID || 'ERP-MID-001';
    }

    async createQrisTransaction(orderId, amount, customerInfo = {}) {
        if (!orderId || amount <= 0) throw new Error('Invalid transaction data');
        ...
        return {
            ...
            customer: customerInfo.name || 'Karyawan/Vendor',
